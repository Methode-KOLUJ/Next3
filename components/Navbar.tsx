...
const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { path: '/emplois', name: 'Emplois' },
      { path: '/Benevole', name: 'Bénévole' },
    ],
  },
  { path: '/Don', name: 'Dons', icon: FaDonate, iconColor: 'text-yellow-500' },
  {
    name: 'Médias', icon: FaFilm, iconColor: 'text-teal-500',
    subItems: [
      { path: '/YouTube', name: 'Films' },
      { path: '/YouTubes', name: 'Chaînes' },
      { path: 'https://seedmagasine73.blogspot.com', name: 'Magazine', external: true },
    ],
  },
  { path: '/Chatbot', name: 'Chatbot', icon: FaRobot, iconColor: 'text-gray-300' },
...
const Navbar = () => {
                ...
                {subItem.external || subItem.path.startsWith('http') ? (
                  ...
                  <Link
                    ...
                    className={`block px-3 py-2 text-sm ${
                      isActive(subItem.path) ? 'bg-yellow-50 text-yellow-600' : 'text-gray-700 hover:bg-blue-50'
  ...
  return (
    ...
    >
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed top-0 left-0 right-0 bg-gray-900 text-white shadow-lg h-screen overflow-y-auto">
